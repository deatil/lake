...
class StrRandom 
{
    ...
    public static function randomFloat(
        ...
        if ($floatLength > 1) {
            $rand = Random::numeric($floatLength - 1);
        }
    ...
    public static function randomDomain() 
    {
        ...
        return strtolower(Random::alpha($len)) . '.' . self::randomTld();
    }
    ...
    public static function randomEmail($domain = '') 
    {
        ...
        return Random::alpha($len) . '@' . $domain;
    ...
    public static function randomPhone() 
    {
        ...
        return $prefixArr[0] . Random::numeric(8);
    }
    ...
    public static function randomId() 
    {
        ...
        return $prefixArr[0] . '0000' . self::randomDate('Ymd') . Random::numeric(3, 1) . $suffixArr[0];
    }
}
