...
class Tree
{
     ...
     * @return array
     */
    public function getParents($lists = [], $id = '', $sort = 'desc')
    {
        $trees = [];
        foreach ($lists as $value) {
            if ((string) $value['parentid'] == (string) $id) {
                ...
                if ($sort == 'asc') {
                    ...
                    $trees = array_merge($this->getParents($lists, $value['id'], $sort), $trees);
                }
            }
        }
        return $trees;
     ...
     * @return array
     */
    public function getChildsId($lists = [], $pid = '', $sort = 'desc')
    {
        $result = [];
        foreach ($lists as $value) {
     ...
     * @return array
     */
    public function getChilds($lists = [], $pid = '', $sort = 'desc')
    {
        $result = [];
        foreach ($lists as $value) {
            if ((string) $value['parentid'] == (string) $pid) {
